...
import logo from "../assets/icons/bathing.png";
...
export default function ElderlyBathHygiene() {
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-6 sm:px-6 md:px-10">
      <div className="text-xl font-bold text-[#007299] mb-6">
        Elderly Bath Hygiene
      </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Safe and comfortable elderly bathing and hygiene.
            </p>
          </div>
        </div>
      ...
      <CaretakerSummary
        logo={logo}
        caretaker="Elderly Bath & Hygiene"
