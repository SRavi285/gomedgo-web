...
import logo from "../assets/icons/assistant.png";
...
export default function Physiotherapy() {
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-6 sm:px-6 md:px-10">
      <div className="text-xl font-bold text-[#007299] mb-2">Physiotherapy</div>
      <h2 className="text-2xl font-bold text-gray-800 mb-6">
        Select Your Physiotherapy Plan
      </h2>
